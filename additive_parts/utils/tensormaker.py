...
args.json_dir = os.path.join(args.json_dir, "sanitized_dict.json")
...
norm_path = os.path.join(args.base_dir, "rawnorm")
os.makedirs(cloud_path, exist_ok=True)
os.makedirs(norm_path, exist_ok=True)

out_paths = process_map(make_tensor, d.keys(), chunksize=500)
# for k in d.keys():
#     make_tensor(k)
cloud_dict = {}
norms_dict = {}
...
with open(os.path.join(args.base_dir, "rawnorm.json"), "w") as w:
